...
import pekko.event.{ LogSource, Logging, MarkerLoggingAdapter }
...
@InternalApi private[bootstrap] abstract class SelfAwareJoinDecider(
  ...
  protected val log: MarkerLoggingAdapter = Logging.withMarker(system, getClass)(LogSource.fromClass)
