...
@InternalApi private[pekko] class KubernetesApiImpl(
  ...
  PATH: to get a specific one: /apis/pekko.apache.org/v1/namespaces/<namespace>/podcosts/<system-name>
  curl -v -X POST localhost:8080/apis/pekko.apache.org/v1/namespaces/<namespace>/podcosts/ -H "Content-Type: application/yaml" --data-binary "@pod-cost-example.yml"
  ...
  /*
curl -v -X PUT localhost:8080/apis/pekko.apache.org/v1/namespaces/<namespace>/podcosts/<system-name> --data-binary "@pod-cost-example.yml" -H "Content-Type: application/yaml"
